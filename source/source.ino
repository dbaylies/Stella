...
AudioConnection          patchCord1(i2s1, 0, i2s2, 0); // direct audio output for monitoring
AudioConnection          patchCord2(i2s1, 0, i2s2, 1); // direct audio output for monitoring
AudioConnection          patchCord3(i2s1, 0, biquad1, 0);
AudioConnection          patchCord4(i2s1, 0, queue1, 0); // this is probably for debugging
