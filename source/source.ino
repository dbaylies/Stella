...
{  
  ...
  if (myFFT.available()) 
  {
    ...
    CapturePeak(mindex, m, peakdetect);
    sendMIDIdata(mindex, m, peakdetect);
  }
}
...
{
  // Check pot inputs
  int v1 = analogRead(16);
  int v2 = analogRead(14);
  int v3 = analogRead(17);
  ...
  int combo = (valve1 << 2) + (valve2 << 1) + valve3;
...
int CapturePeak(int& mindex, float& m, bool& peakdetect)
{
